...
Este proyecto implementa un **pipeline completo de análisis y clasificación de resoluciones judiciales** (disponibles públicamente anonimizadas) utilizando herramientas nativas de Google Cloud.  
